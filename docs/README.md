...
| 许可证 | **MIT**（2026-09-03 拍板，仓库根 `LICENSE`；开源待办均以代码形式公开为前提，若转向闭源商业发行需先回改本行并替换 LICENSE 文件） |
...
| [07_竞品对比与改进机会分析.md](07_竞品对比与改进机会分析.md) | 竞品矩阵、改进机会 backlog（唯一状态源）、量化基线 |
| [08_发布与更新流程.md](08_发布与更新流程.md) | 版本单一来源、发布触发条件、Release 作业图、更新通知、密钥轮换与异常处置 |
| [09_内存与性能治理专项-2026-09-18.md](09_内存与性能治理专项-2026-09-18.md) | 内存门禁三件套口径（增长曲线 / 无界审计 / exe 差分）、基线实测与归因、A 编号进度 |
| [10_TickTick对标差距分析-移动端.md](10_TickTick对标差距分析-移动端.md) | TickTick 对标差距盘点（仅移动端）：能力现状去重名单、A/B/C 三类差距矩阵、UI/UX 差距、优先级候选（待圈选）——只读分析，不含代码改动 |
